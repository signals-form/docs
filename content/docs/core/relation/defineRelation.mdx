...
| `dirtyIgnore` | `boolean` | `true` | Whether to ignore dirty value updates (always execute update) |
...
> {
  ...
  options?: {
    ...
    immediate?: boolean;
    /** If true, the relation will be allowed to skip updates multiple times, default is true */
    dirtyIgnore?: boolean;
